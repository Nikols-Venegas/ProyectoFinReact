...
export default class Details extends Component {
	render() {
		...
		return (
			<ImageBackground source={{uri: params.itemObject.carga}} style={styles.image}>
				...
				<View style={styles.container}>
					...
					>
						...
						<Text style={{paddingStart: 10, fontSize: 13}}>{params.itemObject.DescripcionPedido}</Text>
						<Text style={{paddingStart: 10, fontSize: 13}}>
							Partida: {params.itemObject.UbicacionInicio} - Destino: {params.itemObject.UbicacionDestino}
						</Text>
						<Text style={{paddingStart: 10, fontSize: 13}}>PEN {params.itemObject.Precio}</Text>
					</View>
				</View>
			</ImageBackground>
		);
