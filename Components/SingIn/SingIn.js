...
import {View, Text, Image, Dimensions, StyleSheet, Button, Alert, TouchableOpacity, TextInput} from 'react-native';
...
export default class All extends Component {
	...
	onPress = () => {
		...
		if (this.state.userValue == 'Fabrizio' && this.state.passwordValue == '123') {
							...
							<View style={{padding: 5}}>
								...
								<View style={{alignItems: 'center', marginTop: 15}}>
									...
									<TouchableOpacity onPress={showAlert}>
										<Text style={{color: '#0094EA', fontWeight: 'bold'}}> Registrarse </Text>
									</TouchableOpacity>
								</View>
							</View>
						</View>
